    ...
    <body ng-controller="RoomCtrl">
        ...
        <div class="container">
            <form class="form-horizontal">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="data">Min</label>
                    <div class="col-sm-10">
                        <input ng-model="vi_min" type="number" class="form-control" id="data" placeholder="Nhập dữ liệu, cách nhau dấu ;">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="data">Max</label>
                    <div class="col-sm-10">
                        <input ng-model="vi_max" type="number" class="form-control" id="data" placeholder="Nhập dữ liệu, cách nhau dấu ;">
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <label class="form-control" id="sum">{{Q1}} - {{Q2}} - {{Q3}}</label>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!--Chuan hoa tp-->
            <fieldset class="scheduler-border">
                <legend class="scheduler-border">Chuẩn hóa</legend>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label col-sm-12" for="sorted_list">Giá trị j: <span class="badge">{{j_decimal}}</span></label>
                            <label class="control-label col-sm-12" for="sorted_list">Giá trị min - max: <span class="badge">{{vi_min}} - {{vi_max}}</span></label>
                            <label class="control-label col-sm-12" for="sorted_list">Giá trị sA: <span class="badge">{{sA}}</span></label>
                            <div class="col-sm-1">
                    ...
                    <div class="col-md-12">
                        <table class="table table-striped">
                            <tbody>
                                <tr>
                                    <td><b>Giá trị gốc</b></td>
                                    <td ng-repeat="item in sorted_list  track by $index">{{item}}</td>
                                </tr>
                                <tr>
                                    <td><b>Chuẩn hóa thập phân</b></td>
                                    <td ng-repeat="item in vi_decimal  track by $index">{{item}}</td>
                                </tr>
                                <tr>
                                    <td><b>Chuẩn hóa z-score</b></td>
                                    <td ng-repeat="item in vi_zscore  track by $index">{{item}}</td>
                                </tr>
                                <tr>
                                    <td><b>Chuẩn hóa min-max</b></td>
                                    <td ng-repeat="item in vi_minmax track by $index">{{item}}</td>
                                </tr>
                            </tbody>
                        </table>
